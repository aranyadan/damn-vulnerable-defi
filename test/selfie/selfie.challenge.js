...
describe("[Challenge] Selfie", function () {
    ...
    it("Exploit", async function () {
        ...
        console.log(`Deployed attacker at ${attackerContract.address}`);

        let tx = await attackerContract.attackGovernance();
        tx.wait(1);
        const actionId = await attackerContract.getActionId();
